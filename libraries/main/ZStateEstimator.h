...
private:
  ...
  const float depthCal_slope = -0.752;   //modify these values based on the thing
  const float depthCal_intercept = 2.95-0.70;    //based on manual calibration curve using teensy measured values
