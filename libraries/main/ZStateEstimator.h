...
private:
  ...
  const float depthCal_slope = -1.48;   //modify these values based on the thing
  const float depthCal_intercept = 4.48;    //based on manual calibration curve using teensy measured values
