...
private:
  ...
  const float depthCal_slope = -1.27;   //modify these values based on the thing
  const float depthCal_intercept = 3.27;    //based on manual calibration curve using teensy measured values
